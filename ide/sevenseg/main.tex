...
The ESP32-devkit-v1 has some ground pins, ADC\brak{Analog to Digital Comnverter} input pins D2, D4, D12-D15, D25-D26, D32-D35, VN, VP that can be used for both input as well as output. It also has two power pin that can generate 3.3$V$.  In the following exercises, only the GND, 3.3$V$ and digital pins will be used.
\end{enumerate}
%
